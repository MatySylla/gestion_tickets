...
class _ConnexionState extends State<Connexion> {
  ...
  bool _obscureTextPswd =
      true; // Ajout de _obscureTextPswd pour le contrôle de visibilité du mot de passe

  String? _validateEmail(String? value) {
    if (value == null ||
        value.isEmpty ||
        !RegExp(r"^[a-zA-Z0-9]+\.[a-zA-Z0-9]+@univ-thies\.sn$")
            .hasMatch(value)) {
  ...
  Future<void> _signInWithEmailAndPassword(BuildContext context) async {
    try {
      ...
      if (user != null && _formKey.currentState!.validate()) {
        ...
        // Vérifier l'email de l'utilisateur pour décider de la redirection
